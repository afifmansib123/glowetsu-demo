...
export default function HomePage() {
  ...
  const cardVariants = {
    ...
    hover: {
      ...
      rotateY: 2, // Reduced from 10
      rotateX: 1, // Reduced from 5
    ...
    >
          ...
          >
            ...
            >
              ...
              <div className="absolute inset-0 flex items-center justify-center text-center text-white">
                ...
                >
                  <motion.h1
                    className="text-5xl md:text-7xl font-light tracking-wider mb-6 bg-gradient-to-r from-white via-gray-100 to-white bg-clip-text text-transparent"
      ...
      >
        <div className="max-w-7xl mx-auto px-4 relative z-10">
          ...
          >
            <motion.h2
              className="text-4xl font-light tracking-wide text-white mb-4 bg-gradient-to-r from-white via-gray-200 to-white bg-clip-text text-transparent"
              style={{ fontFamily: 'Georgia, "Times New Roman", serif' }}
            ...
            >
              {t("home.featured.subtitle") ||
                "Discover our handpicked premium experiences"}
            </motion.p>
          </motion.div>
          ...
          {loading ? (
            ...
            >
              {featuredTours.map((tour, index) => (
                ...
                >
                  <Card className="overflow-hidden hover:shadow-2xl border border-gray-600/30 bg-black/40 backdrop-blur-md h-full transition-all duration-500 hover:border-amber-300/50">
                    <motion.div className="relative h-48 group">
                      <motion.img
                      ...
                      {/* Category Badge */}
                      <Badge className="absolute top-4 left-4 bg-black/80 backdrop-blur-sm text-amber-300 border border-amber-300/30 shadow-2xl font-light tracking-wide">
                        {tour.category?.name || "Uncategorized"}
                      </Badge>

                      {/* Price */}
                      <motion.div
                        className="absolute top-4 right-4 bg-black/70 px-3 py-2 rounded-lg text-sm font-bold text-white shadow-lg"
                    ...
                    <CardContent className="p-6 relative">
                      <motion.h3
                        className="text-xl font-medium tracking-wide mb-2 text-white line-clamp-1"
                        style={{
        ...
        <div className="max-w-7xl mx-auto px-4 relative z-10">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <motion.div variants={itemVariants as any}>
              <motion.h2
                className="text-4xl font-bold text-white mb-6 bg-gradient-to-r from-white to-gray-200 bg-clip-text text-transparent"
