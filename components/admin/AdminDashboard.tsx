...
const AdminDashboard: React.FC = () => {
  ...
  const contentManagement = [
    {
      title: t("admin.content.editCarousel"),
      description: t("admin.content.editCarouselDesc"),
      href: "/admin/content/carousel",
      icon: Image,
      color: "bg-orange-500 hover:bg-orange-600",
    },
    {
      title: t("admin.content.editWhyChoose"),
      description: t("admin.content.editWhyChooseDesc"),
      href: "/admin/content/why-choose-us",
      icon: Award,
      color: "bg-teal-500 hover:bg-teal-600",
    },
    {
      title: t("admin.content.editAbout"),
      description: t("admin.content.editAboutDesc"),
  ...
  return (
    ...
    >
      <div className="space-y-6">
        ...
        <div>
          <h2 className="text-lg font-semibold text-gray-900 mb-4">
            {t("admin.content.management")}
          </h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            {contentManagement.map((action) => {
              const Icon = action.icon;
              return (
                <Link key={action.href} href={action.href}>
                  <Card className="hover:shadow-lg transition-shadow cursor-pointer">
